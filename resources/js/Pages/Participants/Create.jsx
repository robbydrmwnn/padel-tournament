...
export default function Create({ category }) {
    ...
    return (
        <AuthenticatedLayout header="Add Participant">
            ...
            <div className="py-12 bg-dark min-h-screen">
                <div className="mx-auto max-w-3xl px-6 lg:px-8">
                    ...
                    <nav className="text-sm font-gotham text-neutral-400 mb-6">
                        ...
                        {' / '}
                        <span className="text-white font-bold">Add Participant</span>
                    </nav>
                    ...
                    <div className="bg-success rounded-2xl p-8 mb-8 shadow-lg border-4 border-accent">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h1 className="text-3xl font-bold font-raverist text-white mb-1">Add New Participant</h1>
                                <p className="text-lg font-gotham text-neutral-200">Register a team for {category.name}</p>
                            </div>
                        </div>
                    </div>
