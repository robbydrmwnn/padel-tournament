                ...
                <div className="mx-auto max-w-7xl sm:px-6 lg:px-8 space-y-6">
                    ...
                    {showImport && (
                        <div className="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                            <div className="p-6">
                                <h3 className="text-lg font-bold font-raverist text-dark mb-4">Import Participants from Excel</h3>
                                ...
                                <div className="mb-4 p-4 bg-primary-50 rounded-lg">
                                    ...
                                    <div className="mt-3">
                                        <a
                                            ...
                                            className="inline-flex items-center text-sm font-medium text-primary hover:text-primary-800"
                                        >
                                ...
                                <form onSubmit={handleImport} className="space-y-4">
                                    <div>
                                        <label htmlFor="file" className="block text-sm font-medium text-dark mb-2">
                                            Upload Excel File
                                        </label>
                                        <input
                                            id="file"
                                    ...
                                    <div className="flex gap-3">
                                        <button
                                            ...
                                            className="inline-flex items-center rounded-md bg-primary px-4 py-2 text-sm font-gotham font-semibold font-gotham text-white shadow-sm hover:bg-primary-600 disabled:opacity-50 disabled:cursor-not-allowed"
                                        >
                        ...
                        <div className="p-6">
                            {participants.length === 0 ? (
                                <div className="text-center py-12">
                                    <p className="text-neutral-600">No participants found. Add your first participant!</p>
                                </div>
                            ) : (
                                                ...
                                                <tr key={participant.id}>
                                                    ...
                                                    <td className="px-6 py-4 whitespace-nowrap text-sm">
                                                        ...
                                                        <Link
                                                            ...
                                                            className="text-neutral-700 hover:text-dark"
                                                        >
                                                            View
                                                        </Link>
                                                    </td>
