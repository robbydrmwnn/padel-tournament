...
export default function Create({ event }) {
    const { data, setData, post, processing, errors } = useForm({
        ...
        group_best_of_games: 4,
        group_scoring_type: 'no_ad',
        group_advantage_limit: '',
        group_tiebreaker_points: 7,
        group_tiebreaker_two_point_difference: true,
        knockout_best_of_games: 6,
        knockout_scoring_type: 'no_ad',
        knockout_advantage_limit: '',
        knockout_tiebreaker_points: 7,
        knockout_tiebreaker_two_point_difference: true,
        warmup_minutes: 5,
    });
